...
class AboutTuples(unittest.TestCase):
    ...
    def test_tuples_are_immutable_so_item_assignment_is_not_possible(self):
        ...
        try:
            ...
            self.assertRaisesRegexp("'tuple' object does not support item assignment", ex[0])
    ...
    def test_tuples_are_immutable_so_appending_is_not_possible(self):
        ...
        try:
            ...
            self.assertRaisesRegexp("object has no attribute 'append'", ex[0])
    ...
    def test_creating_empty_tuples(self):
        self.assertEqual((), ())
        self.assertEqual((), ())  # Sometimes less confusing
